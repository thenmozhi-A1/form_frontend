...
import { t as toPropertyKey } from "./toPropertyKey-BAzEsqeL.js";
...
//#endregion
//#region node_modules/signature_pad/dist/signature_pad.mjs
...
function SignaturePad(canvas, options) {
	...
	if (this.throttle) this._strokeMoveUpdate = throttle(SignaturePad.prototype._strokeUpdate, this.throttle);
...
SignaturePad.prototype.toDataURL = function(type) {
	var _canvas;
	switch (type) {
		case "image/svg+xml": return this._toSVG();
		default:
...
//#endregion
//#region node_modules/react-signature-canvas/dist/index.mjs
var import_build = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(e, t) {
		...
		return function(e) {
			...
			"use strict";
			function r(e) {
				var t = e.getContext("2d"), r = e.width, n = e.height, o = t.getImageData(0, 0, r, n).data, f = a(!0, r, n, o), i = a(!1, r, n, o), c = u(!0, r, n, o), p = u(!1, r, n, o) - c + 1, l = i - f + 1, s = t.getImageData(c, f, p, l);
			...
			function a(e, t, r, n) {
				for (var a = e ? 1 : -1, f = e ? 0 : r - 1; e ? f < r : f > -1; f += a) for (var i = 0; i < t; i++) if (o(i, f, t, n)) return f;
				return null;
			}
			function u(e, t, r, n) {
				for (var a = e ? 1 : -1, f = e ? 0 : t - 1; e ? f < t : f > -1; f += a) for (var i = 0; i < r; i++) if (o(f, i, t, n)) return f;
				return null;
			}
...
var SignatureCanvas = /* @__PURE__ */ function(_Component) {
	...
	function SignatureCanvas() {
		...
		_this.setRef = function(ref) {
			_this._canvas = ref;
			if (_this._canvas === null) _this._sigPad = null;
		};
		_this._excludeOurProps = function() {
			var _this$props = _this.props;
			_this$props.canvasProps;
			_this$props.clearOnResize;
			return _objectWithoutProperties(_this$props, _excluded);
		};
		...
		_this.getCanvas = function() {
			if (_this._canvas === null) throw _this.staticThis.refNullError;
		...
		_this.getTrimmedCanvas = function() {
			...
			return (0, import_build.default)(copy);
		};
		_this.getSignaturePad = function() {
			if (_this._sigPad === null) throw _this.staticThis.refNullError;
			return _this._sigPad;
		};
		_this._checkClearOnResize = function() {
			if (!_this.props.clearOnResize) return;
			_this._resizeCanvas();
		};
		_this._resizeCanvas = function() {
			...
			if (typeof width === "undefined") canvas.width = canvas.offsetWidth * ratio;
			if (typeof height === "undefined") canvas.height = canvas.offsetHeight * ratio;
			canvas.getContext("2d").scale(ratio, ratio);
			_this.clear();
		};
		_this.render = function() {
			var canvasProps = _this.props.canvasProps;
			return /* @__PURE__ */ import_react.createElement("canvas", _extends({ ref: _this.setRef }, canvasProps));
		};
		_this.on = function() {
...
SignatureCanvas.defaultProps = { clearOnResize: true };
SignatureCanvas.refNullError = /* @__PURE__ */ new Error("react-signature-canvas is currently mounting or unmounting: React refs are null during this phase.");
//#endregion
