      ...
      <div className="form-wrapper" ref={componentRef}>
        ...
        <section className="mobile-only mobile-cards-section">
          ...
          <div className="mobile-payment-details">
            ...
            <div className="customer-row vertical" style={{ marginTop: '20px' }}>
              <span className="bold-label">Cheque Date :</span>
            ...
            <div className="customer-row vertical">
              <span className="bold-label">Bank Name :</span>
              <input type="text" name="bankName" value={formData.bankName} onChange={handleChange} className="line-input" />
            </div>

            <div className="customer-row vertical">
              <span className="bold-label">Cheque Number :</span>
              <input type="text" name="chequeNumber" value={formData.chequeNumber} onChange={handleChange} className="line-input" />
            </div>

            <div className="customer-row vertical">
              <span className="bold-label">Amount Received :</span>
              <input type="text" name="amountReceived" value={formData.amountReceived} onChange={handleChange} className="line-input" />
            </div>

            <div className="customer-row vertical">
              <span className="bold-label">Amount Balance :</span>
              <input type="text" name="amountBalance" value={formData.amountBalance} onChange={handleChange} className="line-input" />
            </div>
          </div>
